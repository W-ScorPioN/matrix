...
contract OABE{
    ...
    function uploadX(uint8[3][3] memory inputX1, uint8[3][3] memory inputX2, uint8[3][3] memory inputX3, uint8[3][3] memory inputX4, bytes32 COMM, bytes32 COMM_P) public returns(bool){
    ...
    function SendResult(uint16[3][3] memory inputC1, uint16[3][3] memory inputC2) public returns(bool){
    ...
    function uploadP(uint8[3] memory inputP1, uint8[3] memory inputP3, uint8[3] memory inputP1_1, uint8[3] memory inputP3_1, string memory strbeforehash, string memory pbeforehash,uint res, uint x_digit, uint y_digit) public returns(bool){
